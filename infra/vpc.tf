...
# --- NAT Gateway (permite saída de internet das subnets privadas) ---
...
resource "aws_security_group" "alb" {
  ...
  description = "Permite HTTPS/HTTP da internet ate o ALB"
  vpc_id      = aws_vpc.main.id
...
resource "aws_security_group" "ecs_tasks" {
  ...
  description = "Permite trafego do ALB ate as tasks ECS"
  vpc_id      = aws_vpc.main.id
...
resource "aws_security_group" "rds" {
  ...
  description = "Permite conexao Postgres apenas das tasks ECS"
  vpc_id      = aws_vpc.main.id
